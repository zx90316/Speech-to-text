...
名稱                               語句數   未覆蓋  覆蓋率   未覆蓋行
----------------------------------------------------------------
backend/api.py                 367      367     0%    6-1094
backend/crypto_utils.py        138       19    86%    42-52, 147-148, 221-222, 332-338
backend/email_service.py       137       13    91%    117-119, 142, 208-209, 223-224, 241-242, 246-248
backend/input_validator.py     198       18    91%    68, 143, 159, 176, 184, 194, 199, 204, 213, 230, 235, 254, 274, 298, 302, 380, 384, 464
backend/memory_storage.py      182       26    86%    125, 145-147, 162, 170, 198, 205-224, 248, 267, 300-302
backend/ollama_service.py      100      100     0%    5-369
backend/rate_limiter.py        133        7    95%    79, 123, 275, 293-296
backend/security_logger.py      87        0   100%    -
backend/task_processor.py      528      528     0%    5-1310
----------------------------------------------------------------
總計                               1870     1078    42%
```
